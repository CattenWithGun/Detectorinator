...
namespace NetworkTraining
{
  public static class Training
  {
    public static NeuralNetwork TrainNetwork(NeuralNetwork network)
    {
      ...
      byte[] labels = GetLabels("/home/runner/NeuralNetwork/MNIST_Test_Database/labels");
      byte[,,] images = GetImages("/home/runner/NeuralNetwork/MNIST_Test_Database/images");
      images = SplitFlipAll(images);
      Random random = new Random();
      WriteImage(random.Next(0,9999), images, labels);
      return network;
    }
    ...
    */
    ...
    private static byte[,,] GetImages(string pathToImageFile)
    {
    ...
    private static void WriteImage(int index, byte[,,] images, byte[] labels)
    {
    ...
    private static byte[] SplitFlip(byte[] row)
    {
    ...
    */
    ...
    private static byte[] GetLabels(string pathToLabelFile)
    {
